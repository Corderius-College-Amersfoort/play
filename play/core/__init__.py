...
def _handle_mouse_loop():
    ...
    ####################################
    if click_happened_this_frame and callback_manager.get_callbacks(CallbackType.WHEN_CLICKED) is not None:
    ...
    ########################################
    if click_release_happened_this_frame and callback_manager.get_callbacks(CallbackType.WHEN_CLICK_RELEASED) is not None:
